        ...
        <div class="md-plus-inner">
            ...
            <div class="md-p-nav2  clearfix">
                <ul class="clearfix font16 floatleft">
                    <li class="current approve"><a href="/wf/reqTask!approveList.dhtml" title="等待您审批的申请"><@c.textI18n value="approvalsUnapproved"/></a></li>
                    <li class="done"><a href="/wf/reqTask!doneList.dhtml" title="您已经审批完成的申请"><@c.textI18n value="approvalsApproved"/></a></li>
                </ul>
            </div>
            <#nested >
        </div>
