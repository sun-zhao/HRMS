...
<!--右侧详细信息begin-->
    ...
    <form action="/hr/employee!saveInfo.dhtml" method="POST" class="formStyle" name="editForm" id="editForm"
                        ...
                        <td colspan="3">
                            <select class="edit" id="hrEmployee.deptName"  name="hrEmployee.deptName">
                                ...
                                <#list departmentList as dept>
                                    <option value="${dept.name?if_exists}"> ${dept.name?if_exists}</option>
                                </#list>
                                </#if>
                            </select>
                        </td>
