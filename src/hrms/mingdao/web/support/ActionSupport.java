package hrms.mingdao.web.support;


import com.mingdao.api.entity.AppConfig;
import com.mingdao.api.utils.AppConfigUtil;
import hrms.mingdao.common.SeachEntity;
import hrms.mingdao.common.SeachRule;
...
public abstract class ActionSupport<T> extends BaseAction {
    ...
    protected String getMdURI() throws Exception {
        AppConfig appConfig = AppConfigUtil.create();
        if(appConfig!=null){
            return mdURI+"?app_key=" + appConfig.getAppKey()+"&redirect_uri=" + URLEncoder.encode(appConfig.getRedirectUri(), "UTF-8");
        }
        return mdURI;
